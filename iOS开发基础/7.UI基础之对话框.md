...
## 列表对话框(我习惯这么叫)
<src <img src="https://github.com/CharonChui/Pictures/blob/master/ios_sheet.png" width="100%" height="100%" />
...
class ViewController: UIViewController {
    // 这个是界面中有个Button的点击事件，在Main.storyboard中选中Button右键拖到ViewController中，然后会弹一个输入框，输入名称，如果是点击事件在connection中选择Action，如果是属性选择Qutlet
...
<src <img src="https://github.com/CharonChui/Pictures/blob/master/ios_alert.png" width="100%" height="100%" />
```swift
import UIKit
...
<src <img src="https://github.com/CharonChui/Pictures/blob/master/ios_alert_input.png" width="100%" height="100%" />
...
<src <img src="https://github.com/CharonChui/Pictures/blob/master/ios_toast.png" width="100%" height="100%" />
